...
<script setup lang="ts">
	...
	onMounted(() => {
		setInterval(() => {
			...
			if ( progressNumber.value > 100 ) progressNumber.value = 0;
		}, 25);
	});
</script>
...
/* From Uiverse.io by csemszepp */
	...
	@keyframes lightEffect {
		0%, 20%, 40%, 60%, 80%, 100% {
			background: repeating-linear-gradient(45deg, var(--color-primary) 0 30px, var(--color-secondary) 0 40px) right/200% 100%;
		}

		10%, 30%, 50%, 70%, 90% {
			background: repeating-linear-gradient(45deg, var(--color-primary) 0 30px, var(--color-secondary) 0 40px, rgba(255, 255, 255, 0.3) 0 40px) right/200% 100%;
		}
	}
</style>